...
SQLATE_EXPORT void insert(const QString &dbConnectionName, const QString &queryStatement,
                          const SqlQuery &query);

/// Clears the cache, must be called whenever the corresponding database connection is dropped.
SQLATE_EXPORT void clear();

/// Enables/disables the query cache. This can be used to temporarily disable caching while changing
/// the db layout.
