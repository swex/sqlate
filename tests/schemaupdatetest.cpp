...
private:
    ...
    bool containsColumn(const QVector<QPair<QString, QVariant::Type>> &cols, const char *name,
                        QVariant::Type type)
    {
...
private slots:
    ...
    void testSchemaUpdate()
    {
        ...
        QVector<QPair<QString, QVariant::Type>> cols =
            SqlUtils::columnsOfTable(OldSql::Existing, db);
