...
private Q_SLOTS:
    ...
    void testInsert_data()
    {
        ...
        QTest::newRow("single col, one value")
            << insert()
                   .into(Person)
                   .columns(Person.PersonSurname << QLatin1String("Ford"))
                   .queryBuilder()
        ...
        QTest::newRow("two col, two values")
            << insert()
                   ...
                   .columns(Person.PersonForename << QLatin1String("Ford")
                            & Person.PersonSurname << QLatin1String("Prefect"))
                   .queryBuilder()
        ...
        QTest::newRow("two col, bool and datetime")
            << insert()
                   .into(Person)
                   .columns(Person.HireRights << false
                            & Person.Hired << QDateTime(QDate(2013, 1, 1)))
                   .queryBuilder()
