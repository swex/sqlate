...
private Q_SLOTS:
    void testSingleCreation()
    {
        QString s = QString::fromLatin1(
            ...
            "fk_lutPersonGrades_id UUID NOT NULL REFERENCES lutPersonGrades (id) ON DELETE "
            "RESTRICT,\n"
    ...
    void testExtendedLookupTable()
    {
        QString s = QString::fromLatin1("CREATE TABLE lutPersonGrades (\n"
                                        ...
                                        "short_desc VARCHAR(128),\n"
                                        "description VARCHAR(255),\n"
                                        "fk_lutPersonRoles_id UUID NOT NULL REFERENCES "
                                        "lutPersonRoles (id) ON DELETE RESTRICT\n)");
    ...
    {
        QString s = QString::fromLatin1(
            "CREATE TABLE rltPersonSubRoles (\n"
    ...
    {
        QString s =
            QString::fromLatin1("CREATE TABLE rltPersonBossRelation (\n"
                                "fk_tblPerson_id UUID NOT NULL REFERENCES tblPerson (id),\n"
