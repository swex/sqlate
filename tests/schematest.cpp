...
private Q_SLOTS:
    ...
    void testTypeAccess()
    {
        ...
        BOOST_MPL_ASSERT((boost::is_same<Sql::PersonType::PersonGradeType::referenced_column,
                                         Sql::PersonGradesType::idType>));
    }
    ...
    {
        BOOST_MPL_ASSERT((boost::is_same<Sql::PersonSubRolesRelationType::leftType,
                                         Sql::PersonSubRolesRelationType::fk_tblPerson_idType>));
        QCOMPARE(Sql::PersonSubRolesRelation.left.name(),
                 Sql::PersonSubRolesRelation.fk_tblPerson_id.name());
    }
};
