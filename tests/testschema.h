...
TABLE(Person, TEST_EXPORT)
{
    ...
    typedef boost::mpl::vector<idType, fk_lutPrefix_idType, PersonForenameType, PersonSurnameType,
                               PersonSuffixType, PersonGradeType, PersonActiveType, HireRightsType,
                               UserNameType, HiredType>
        columns;
};
...
TABLE(WorkTask, TEST_EXPORT)
{
    ...
    typedef append<
        baseConstraints,
        boost::mpl::vector<UniqueConstraint<boost::mpl::vector<foreign_idType, ealEndType>>>>::type
        constraints;
};
TABLE(Workplace, TEST_EXPORT)
{
    ...
    typedef boost::mpl::vector<idType, itemorderType, short_descType, descriptionType,
                               contact_telType, contact_faxType>
        columns;
};
...
#define SCHEMA                                                                                     \
    (Version)(Prefix)(PersonRoles)(PersonSubRoles)(PersonGrades)(Person)(PersonSubRolesRelation)(  \
        Directorates)(SubDirectorates)(PersonSubDirectoratesRelation)(PersonBossRelation)(         \
        WorkTask)(Workplace)(Report)
