...
#define SQL_NETWORK_TIMEOUT                                                                        \
    30 // define how many seconds do we wait for a query finishes until the network error dialog is
       // shown

QMutex mutex;
static bool s_dialogVisible = false;

SqlQueryWatcherHelper::SqlQueryWatcherHelper(QObject *runner)
    : QObject(nullptr)
{
