...
bool SqlQueryCache::contains(const QString &dbConnectionName, const QString &queryStatement)
{
    ...
    return g_queryCache.contains(dbConnectionName)
        && g_queryCache.value(dbConnectionName).contains(queryStatement);
}
...
void SqlQueryCache::insert(const QString &dbConnectionName, const QString &queryStatement,
