 ...
 */
SQLATE_EXPORT QString batchExec(const QString &sql,
 ...
 */
template <typename T>
inline QVector<QPair<QString, QVariant::Type>>
columnsOfTable(const T &table, const QSqlDatabase &db = QSqlDatabase::database())
{
