...
{
    switch (op) {
    case SqlCondition::Equals:
        return QLatin1String(" = ");
    case SqlCondition::NotEquals:
        return QLatin1String(" <> ");
    case SqlCondition::Is:
        return QLatin1String(" IS ");
    case SqlCondition::IsNot:
        return QLatin1String(" IS NOT ");
    case SqlCondition::Less:
        return QLatin1String(" < ");
    case SqlCondition::LessOrEqual:
        return QLatin1String(" <= ");
    case SqlCondition::Greater:
        return QLatin1String(" > ");
    case SqlCondition::GreaterOrEqual:
        return QLatin1String(" >= ");
...
QString SqlConditionalQueryBuilderBase::conditionToString(const SqlCondition &condition)
{
    if (condition.hasSubConditions()) {
        ...
        return QLatin1Char('(') + conds.join(logicOperatorToString(condition.m_logicOp))
            + QLatin1Char(')');
    } else {
